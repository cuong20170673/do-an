...
def setup_task_environment(self):
    ...
    self.waypoints0 = [0.000, 0.176,0.673,0.740 ]
    self.waypoints1 = [-0.347, 4.906,0.673,0.740 ]
    self.waypoints2 = [-3.5, 5,0.7,0.7 ]
    self.waypoints3 = [-6.015, 5.038,0.7,0.7 ]
    self.waypoints4 = [3, 0.538, -0.7,0.7]
    self.waypoints.append(self.waypoints0)
    self.waypoints.append(self.waypoints1)
    self.waypoints.append(self.waypoints2)
    self.waypoints.append(self.waypoints3)
    self.waypoints.append(self.waypoints4)
            

    
    # Create a mapping of room names to waypoint locations
    room_locations = (('hallway', self.waypoints[1]),
                      ('living_room', self.waypoints[2]),
                      ('kitchen', self.waypoints[3]),
                      ('bathroom', self.waypoints[4]))
    ...
    self.docking_station_pose = self.waypoints[0]          
    ...
    for waypoint in self.waypoints:           
        p = Point()
        p =[waypoint[0],waypoint[1],waypoint[2]]
