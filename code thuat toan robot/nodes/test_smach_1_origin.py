    ...
    def __init__(self):
        ...
        with self.sm_patrol:
            ...
            StateMachine.add('PICK_WAYPOINT_3', PickWaypoint(3),
                             transitions={'move_pos_1':'NAV_WAYPOINT_1','move_pos_2':'NAV_WAYPOINT_2','move_pos_3':'NAV_WAYPOINT_3','dont_move':'CON_1'},
                             remapping={'waypoint_out':'patrol_waypoint'})
            ...
            StateMachine.add('NAV_WAYPOINT_3', Nav2Waypoint(),
                             transitions={'succeeded':'CONFIRM_3', 
                                          ...
                                          'preempted':'CONFIRM_3'},
                             remapping={'waypoint_in':'patrol_waypoint'})
            StateMachine.add('CONFIRM_3', MonitorState("/check_confirm", String, self.check_cb), transitions={'invalid':'CON_1', 'valid':'CONFIRM_3', 'preempted':'CONFIRM_3'})                              
