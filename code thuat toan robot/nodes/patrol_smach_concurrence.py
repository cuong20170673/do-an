...
class Patrol():
    def __init__(self):
        ...
        for waypoint in self.waypoints:           
            ...
            nav_goal.target_pose.pose.position.x  = waypoint[0]
            nav_goal.target_pose.pose.position.y  = waypoint[1]
            nav_goal.target_pose.pose.orientation.z  = waypoint[2]
            nav_goal.target_pose.pose.orientation.w  = waypoint[3]
        ...
        nav_goal.target_pose.pose.position.x  = self.waypoints[0][0]
        nav_goal.target_pose.pose.position.y  = self.waypoints[0][1]
        nav_goal.target_pose.pose.orientation.z  = self.waypoints[0][2]
        nav_goal.target_pose.pose.orientation.w  = self.waypoints[0][3]        
        ...
        with self.nav_patrol:
          ...
          # Concurrence.add('MONITOR_BATTERY', MonitorState("battery_level", Float32, self.battery_cb))
           Concurrence.add('MONITOR_BATTERY', MonitorState("/check_confirm", String, self.check_go_cb))
